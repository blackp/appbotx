...
{
    // The test API key, you will need to change this to suit
    [[ABXApiClient instance] setApiKey:@"bc2c1345090cee2262258834db71a1e9417365a7"];
    
    if ([self.window respondsToSelector:@selector(setTintColor:)]) {
        self.window.tintColor = [UIColor colorWithRed:0xf5/255.0f green:0x8c/255.0f blue:0x75/255.0f alpha:1];
    }
